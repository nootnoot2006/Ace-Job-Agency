...
function setDocument( node ) {
	...
	assert( function( el ) {
		...
		// SECURITY FIX: Build test DOM using safe DOM APIs instead of innerHTML
		// to avoid CodeQL "Unsafe HTML constructed from library input" (CWE-79/CWE-116)
		var container = documentElement.appendChild( el );
